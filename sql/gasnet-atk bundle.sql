...
(1, 'Bolpoin', 'Alat Tulis', 103),
(3, 'Stepler', 'Alat Tulis', 1),
(4, 'Paperclip Warna', 'Alat Tulis', 200);
...
(11, 'Erik Santiago', 1, 2, '2018-08-24'),
(12, 'Erik Santiago', 1, 5, '2018-08-27');
...
INSERT INTO `permohonan_kendaraan` (`IDpermohonan`, `tanggalBerangkat`, `namaPengguna`, `satuanKerja`, `tujuan`, `jamBerangkat`, `jamKembali`, `noPol`, `pengemudi`, `tanggalPermohonan`, `kmAwal`, `kmAkhir`, `persekot`, `email`, `approval`) VALUES
(13, '2018-08-14', 'Firly A M', 'IT', 'Jakarta Utara', '10:01:00', '13:00:00', 'B 1235 CD', 'Erik', '2018-08-13', NULL, NULL, NULL, 'firly@gmail.com', 'Disetujui Supervisor'),
(15, '2018-08-15', 'Firly A M', 'IT', 'Jakarta Utara', '14:00:00', '17:00:00', 'B 1234 CD', 'Firdaus', '2018-08-15', NULL, NULL, NULL, 'firly@gmail.com', 'Disetujui Supervisor'),
(16, '2018-08-15', 'Erik Santiago', 'IT', 'Kebon Jeruk', '15:00:00', '17:00:00', 'B 1 GSN', 'Erik Santiago', '2018-08-15', NULL, NULL, NULL, 'eriksantiago.science@gmail.com', 'Disetujui Supervisor'),
(18, '2018-08-16', 'Erik Santiago', 'IT', 'Space', '10:00:00', '13:00:00', 'B 1234 CD', 'Firdaus', '2018-08-15', 0, 0, NULL, 'eriksantiago.science@gmail.com', 'Disetujui Supervisor'),
(19, '2018-08-21', 'Firly A M', 'IT', 'Jakarta Selatan', '14:30:00', '17:30:00', NULL, NULL, '2018-08-21', 0, 0, '500000', 'firly@gmail.com', 'Disetujui Supervisor');
...
('eriksantiago@defaultunj.com', '$2y$10$kajS8iE8fUodhlq/8XzYt.YMR.0gdw8GMY3VHrfWfuQRlZgVHZ/3G', 'Soekarno', 'Admin', 3, 'aktif'),
('firly@gmail.com', '$2y$10$43MWy6Ye/Qo5hkdR5OKiHu/488MNK0ydKa9DUOXGYfDRWuKMK6iE2', 'Firly A M', 'IT', 1, 'aktif'),
('ga@gasnet.id', '$2y$10$7y3DAYV.CimmrU0hK9.fUuhjOQoySAaucjXuPBrVliwtuCitW5KFW', 'Rahmad', '-', 0, 'aktif'),
('rikhi.narang@gasnet.id', '$2y$10$RYhvFnoxmLI3LlwGsn/XjuOgDf7Mv2jBNXSNPfkR1ghuUP7bZn.9C', 'Rikhi', 'Direktur', 2, 'aktif');
...
CREATE TABLE `vendor` (
  ...
  `tgl0SITU` date DEFAULT NULL,
  `tgl1SITU` date DEFAULT NULL,
  `fileRekanan` varchar(255) DEFAULT NULL,
  `ketRekanan` varchar(10) DEFAULT NULL,
  `fileStruktur` varchar(255) DEFAULT NULL,
  `ketStruktur` varchar(10) DEFAULT NULL,
  `TDP` varchar(100) DEFAULT NULL,
  `tgl0TDP` date DEFAULT NULL,
  `tgl1TDP` date DEFAULT NULL,
  `SIUP` varchar(100) DEFAULT NULL,
  `tgl0SIUP` date DEFAULT NULL,
  `tgl1SIUP` date DEFAULT NULL,
  `fileLOU` varchar(255) DEFAULT NULL,
  `ketLOU` varchar(10) DEFAULT NULL,
  `fileKebenaran` varchar(255) DEFAULT NULL,
  `ketKebenaran` varchar(10) DEFAULT NULL,
  `filePengalaman` varchar(255) DEFAULT NULL,
  `ketPengalaman` varchar(10) DEFAULT NULL,
  `filePerlengkapan` varchar(255) DEFAULT NULL,
  `ketPerlengkapan` varchar(10) DEFAULT NULL,
  `sertifkons` varchar(100) DEFAULT NULL,
  `tgl0sertifkons` date DEFAULT NULL,
  `tgl1sertifkons` date DEFAULT NULL,
  `SIUJK` varchar(100) DEFAULT NULL,
  `tgl0SIUJK` date DEFAULT NULL,
  `tgl1SIUJK` date DEFAULT NULL,
  `ijinDisnak` varchar(100) DEFAULT NULL,
  `tgl0ijinDisnak` date DEFAULT NULL,
  `tgl1ijinDisnak` date DEFAULT NULL,
  `ijinDeper` varchar(100) DEFAULT NULL,
  `tgl0ijinDeper` date DEFAULT NULL,
  `tgl1ijinDeper` date DEFAULT NULL,
  `sertifKonsul` varchar(100) DEFAULT NULL,
  `tgl0sertifKonsul` date DEFAULT NULL,
  `tgl1sertifKonsul` date DEFAULT NULL,
  `suratAgen` varchar(100) DEFAULT NULL,
  `tgl0suratAgen` date DEFAULT NULL,
  `tgl1suratAgen` date DEFAULT NULL,
  `NPWP` varchar(20) DEFAULT NULL,
  `fileSPPKP` varchar(255) DEFAULT NULL,
  `ketSPPKP` varchar(10) DEFAULT NULL,
  `fileSPT` varchar(255) DEFAULT NULL,
  `ketSPT` varchar(10) DEFAULT NULL,
  `fileSSP` varchar(255) DEFAULT NULL,
  `ketSSP` varchar(10) DEFAULT NULL,
  `bank` varchar(100) DEFAULT NULL,
  `norek` varchar(20) DEFAULT NULL,
  `ekuitas` varchar(20) DEFAULT NULL,
  `fileNeraca` varchar(255) DEFAULT NULL,
  `ketNeraca` varchar(10) DEFAULT NULL,
  `aktePendirian` varchar(100) DEFAULT NULL,
  `tglAktePendirian` date DEFAULT NULL,
  `fileAktePendirian` varchar(255) DEFAULT NULL,
  `ketAktePendirian` varchar(10) DEFAULT NULL,
  `aktePerubahan` varchar(100) DEFAULT NULL,
  `tglAktePerubahan` date DEFAULT NULL,
  `fileAktePerubahan` varchar(255) DEFAULT NULL,
  `ketAktePerubahan` varchar(10) DEFAULT NULL,
  `masaJabatanDireksi` date DEFAULT NULL,
  `fileKTP` varchar(255) DEFAULT NULL,
  `ketKTP` varchar(10) DEFAULT NULL,
  `direktur1` varchar(50) DEFAULT NULL,
  `jabdir1` varchar(50) DEFAULT NULL,
  `direktur2` varchar(50) DEFAULT NULL,
  `jabdir2` varchar(50) DEFAULT NULL,
  `direktur3` varchar(50) DEFAULT NULL,
  `jabdir3` varchar(50) DEFAULT NULL,
  `komisaris1` varchar(50) DEFAULT NULL,
  `jabkom1` varchar(50) DEFAULT NULL,
  `komisaris2` varchar(50) DEFAULT NULL,
  `jabkom2` varchar(50) DEFAULT NULL,
  `komisaris3` varchar(50) DEFAULT NULL,
  `jabkom3` varchar(50) DEFAULT NULL,
  `bidang1` varchar(50) DEFAULT NULL,
  `jenisBidang1` varchar(50) DEFAULT NULL,
  `bidang2` varchar(50) DEFAULT NULL,
  `jenisBidang2` varchar(50) DEFAULT NULL,
  `bidang3` varchar(50) DEFAULT NULL,
  `jenisBidang3` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `permintaan_barang`
  MODIFY `IDpermintaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
